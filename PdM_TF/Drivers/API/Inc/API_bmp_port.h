 ...
 * based on use cases */
#define BMP_PARAM_OSRP				(0x05<<2)	// Oversampling Pres x16
#define BMP_PARAM_OSRT				(0x02<<5)	// Oversampling Temp x2
...
#define BMP_PARAM_IIR				(0x04<<2)	// IIR Coeficient 16
#define BMP_PARAM_IIR_MASK			0xE3		// IIR Coeficient Mask
#define BMP_PARAM_STANDBY_MODE		(0x00<<5)	// StandBy Mode 500 [us]
...
#define BMP_SHIFT_LCL_PRESS			36			// deriva de presion respecto de presion local
#define BMP_SHIFT_LCL_TEMP			4			// dervia de temperatura respecto de temp local
